  ...
  return (
      ...
      <div className="conatiner-fluid bg bg-grey pd-5">
        <div className="row justify-content-center">
            <div className="col-12 col-md-4 bg bg-success text-center py-4"><br />
                <h1 className='text text-light'>Welcome to Sign Up </h1><br />
                <h6 className='text text-light'>Do have an account ? </h6><br />
                <button id='log-submit' onClick={changetolog} className='bg bg-light border border-light btn-responsive'>
                  <b>Sign In</b>
                </button>
                {
            ...
            <div className="col-12 col-md-8 text-center mt-4">
              ...
              <h1 className='mt-4'>CREATE YOUR OWN ACCOUNT</h1>
               ...
               <form onSubmit={senddata}>
                ...
                <br /><br />
                <button id='log-submit' type='submit' className='btn btn-success btn-responsive'><b>Sign Up</b></button>
                </form>
                <br /><br /><br /><br /><br /><br />
               </div>
                </div>
