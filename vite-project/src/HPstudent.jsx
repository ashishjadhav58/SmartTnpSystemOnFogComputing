  ...
  function actionperform(e){
    ...
    switch(cleanText){
      ...
      default:
        ...
        if (cleanText.includes("Placement Drive") || text.includes("Placement Drive")) {
          setchoice(2);
          ...
          setchoice(6);
        } else if (cleanText.includes("Resume") || text.includes("Resume")) {
          setchoice(8);
        }
        break;
    }
  ...
  return (
    <div>
      ...
      <div className="container-fluid" style={{ padding: 0, minHeight: '100vh', background: 'var(--color-bg)' }}>
        ...
        <div className="offcanvas offcanvas-start" tabIndex="-1" id="mobileNav" aria-labelledby="mobileNavLabel" style={{ width: '280px' }}>
          <div className="offcanvas-header" style={{ background: 'var(--gradient-primary)', color: 'white', padding: '1.25rem' }}>
            <div className="d-flex align-items-center gap-2">
              <img src="logo.png" alt="Logo" style={{ height: '32px' }} />
              <h5 className="offcanvas-title mb-0" id="mobileNavLabel" style={{ fontWeight: '600', fontSize: '1.1rem' }}>
                Menu
              </h5>
            </div>
          ...
          <div className="offcanvas-body" style={{ padding: '1rem' }}>
            ...
            <div className="d-grid gap-2">
              ...
              <button onClick={(event)=>{ actionperform(event); closeMobileNav(); }} data-bs-dismiss="offcanvas" className='btn btn-light text-start' style={{ borderRadius: '12px', justifyContent: 'flex-start', padding: '0.875rem 1rem' }}>✅ Self Attendance</button>
              ...
              <button onClick={(event)=>{ actionperform(event); closeMobileNav(); }} data-bs-dismiss="offcanvas" className='btn btn-light text-start' style={{ borderRadius: '12px', justifyContent: 'flex-start', padding: '0.875rem 1rem' }}>📄 Resume</button>
